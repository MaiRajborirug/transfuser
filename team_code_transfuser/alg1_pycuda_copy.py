...
cuda_source_code = Path('/media/haoming/970EVO/Pharuj/git/transfuser/team_code_transfuser/alg1_pycuda_copy.cu').read_text()
...
class Algorithm1:
    ...
    def run(self, args):
        ...
        # unpack 
        mu_i, nu_i, v_e, psi_e, a_e, phi_e, is_animated = args
