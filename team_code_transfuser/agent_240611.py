...
from submission_agent_adjust2 import HybridAgent
...
class agent(HybridAgent):
    ...
    def run_step(self, input_data, timestamp):
        ...
        # self.resize_visualize(self.bgr_, 'input')
    ...
    def resize_visualize(self, img, img_name, scale=1, binary_input=True, cert=True):
