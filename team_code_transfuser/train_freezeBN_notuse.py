...
def main():
    ...
    parser.add_argument('--load_file', type=str, default='/home/haoming/git/transfuser/model_ckpt/models_2023/tfuse_scratch_t31_nosc/model_31.pth', help='ckpt to load.')
    parser.add_argument('--start_epoch', type=int, default=31, help='Epoch to start with. Useful when continuing trainings via load_file.')
    ...
    # # freeze BN grad and running mean/var

    # # check if trainable parameter changes
    # model_parameters = filter(lambda p: p.requires_grad, model.parameters())
    # params = sum([np.prod(p.size()) for p in model_parameters])
    # print('Total trainable parameters after freeze BN: ', params)
    # del model_parameters, module, params
...
class Engine(object):
    ...
    def train(self):
        ...
        print(self.model)
        # dropout layer, require_grad =False , module.eval()
